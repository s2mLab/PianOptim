...
with open("../Results/Piano_results_without_pelvis_rotZ.pckl", 'rb') as file: new_dict2 = pickle.load(file)
with open("../Results/Piano_results_without_pelvis_rotZ_and_thorax.pckl", 'rb') as file: new_dict3 = pickle.load(file)
