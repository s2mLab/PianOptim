...
def main():
    ...
    with open(
            "/0:On_going/5:FINAL_Squeletum_hand_finger_2_keys/frappe_&_pressed/4_phases/0_pressed/results/archive_bc_piano_badly_positionate/7_with_hand_and_finger/7.pckl", "wb") as file:
