...
def main():
    ...
    with open(
            "/2__FINAL_MODELES_OSCAR/5___FINAL_Squeletum_hand_finger_1_key_4_phases/pressed/2_finger_hand_ulna_radius_minimize_at_10_000/test_equality/2_finger_hand_ulna_radius_minimize_at_10_000.pckl", "wb") as file:
