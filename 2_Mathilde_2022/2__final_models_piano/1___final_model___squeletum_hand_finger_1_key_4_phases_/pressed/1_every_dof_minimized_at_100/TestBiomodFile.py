...
specific_points_s = [0, data_struck['phase_time'][0], data_struck['phase_time'][0] + data_struck['phase_time'][1], data_struck['phase_time'][0] + data_struck['phase_time'][1] + data_struck['phase_time'][2], data_struck['phase_time'][0] + data_struck['phase_time'][1] + data_struck['phase_time'][2] + data_struck['phase_time'][3]]

T_p=(data_Pressed['phase_time'][0]+data_Pressed['phase_time'][1]+data_Pressed['phase_time'][2]+data_Pressed['phase_time'][3])  #Simulation Time
specific_points_p = [0, data_Pressed['phase_time'][0], data_Pressed['phase_time'][0] + data_Pressed['phase_time'][1], data_Pressed['phase_time'][0] + data_Pressed['phase_time'][1] + data_Pressed['phase_time'][2], data_Pressed['phase_time'][0] + data_Pressed['phase_time'][1] + data_Pressed['phase_time'][2] + data_Pressed['phase_time'][3]]
...
array_0_q_p = data_Pressed['states'][0]['q']  # First array
array_1_q_p = data_Pressed['states'][1]['q']  # Second array
array_2_q_p = data_Pressed['states'][2]['q']  # Third array
array_3_q_p = data_Pressed['states'][3]['q']  # Fourth array
...
#####################
array_0_qdot_p = data_Pressed['states'][0]['qdot']  # First array
array_1_qdot_p = data_Pressed['states'][1]['qdot']  # Second array
array_2_qdot_p = data_Pressed['states'][2]['qdot']  # Third array
array_3_qdot_p = data_Pressed['states'][3]['qdot']  # Fourth array
...
array_0_tau_p = data_Pressed['controls'][0]['tau']  # First array
array_0_tau_p= array_0_tau_p[:, :-1]   #last node is NAN : Not a Number

array_1_tau_p= data_Pressed['controls'][1]['tau']  # Second array
array_1_tau_p= array_1_tau_p[:, :-1]

array_2_tau_p= data_Pressed['controls'][2]['tau']  # Third array
array_2_tau_p= array_2_tau_p[:, :-1]

array_3_tau_p= data_Pressed['controls'][3]['tau']  # Fourth array
...
for i in range(0,10):
    ...
    axs[0].plot(x_q_p, concatenated_array_q_p[i,:], color='blue')
    ...
    axs[1].plot(x_qdot_p, concatenated_array_qdot_p[i,:],color='blue')
    ...
    axs[2].plot(x_tau_p, concatenated_array_tau_p[i,:], color='blue')
