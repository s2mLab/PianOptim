...
def prepare_ocp(
    biorbd_model_path: str = "/home/lim/Documents/Stage Mathilde/PianOptim/2:FINAL_MODELES/2:FINAL_Finger_2_keys_presse/FINAL_Finger_2_keys_presse_VELOCITY_PROFIL/FINAL_Finger_2_keys_presse_VELOCITY_PROFIL.bioMod",
    ...
    vel_push_array = [
        [
            -0.0876676082611084,
            -0.009917981284005307,
            0.05772005489894323,
            0.07722724505833216,
            -0.00027126584734237325,
            -0.19082199505397259,
            -0.6090696471078056,
            -0.9216570854187012,
        ]
    ...
    constraints.add(
        ConstraintFcn.TRACK_CONTACT_FORCES, node=Node.ALL, contact_index=0, min_bound=0, phase=1
    )  # contact index : axe du contact
    ...
    constraints.add(
        ConstraintFcn.TRACK_CONTACT_FORCES, node=Node.ALL, contact_index=0, min_bound=0, phase=4
    )  # contact index : axe du contact
