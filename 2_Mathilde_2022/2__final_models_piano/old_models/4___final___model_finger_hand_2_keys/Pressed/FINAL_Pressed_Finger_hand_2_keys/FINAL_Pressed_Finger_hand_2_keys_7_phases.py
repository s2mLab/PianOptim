...
def prepare_ocp(
    biorbd_model_path: str = "/home/lim/Documents/Stage Mathilde/PianOptim/2:FINAL_MODELES/4:FINAL_Finger_hand_2_keys/Pressed/FINAL_Pressed_Finger_hand_2_keys/FINAL_Pressed_Finger_hand_2_keys_7_phases.bioMod",
    ...
    objective_functions.add(
        ...
        target=vel_pushing,
        node=three_quarter_node_phase_1,
        phase=1,
        marker_index=4,
        weight=1000,
    )
    objective_functions.add(
        ObjectiveFcn.Mayer.TRACK_MARKERS_VELOCITY,
        target=vel_pushing,
        node=three_quarter_node_phase_5,
        phase=5,
        marker_index=4,
        weight=1000,
    )
    ...
    constraints.add(ConstraintFcn.TRACK_CONTACT_FORCES, node=Node.ALL, contact_index=0, min_bound=0, phase=6)
