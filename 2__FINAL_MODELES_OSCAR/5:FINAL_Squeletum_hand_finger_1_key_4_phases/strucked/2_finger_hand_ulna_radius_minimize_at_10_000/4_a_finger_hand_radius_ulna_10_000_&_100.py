...
def prepare_ocp(
        biorbd_model_path: str = "/home/lim/Documents/Stage Mathilde/PianOptim/0__On_going/Resultats_FINAL/strucked/bioMod/Squeletum_hand_finger_3D_2_keys_octave_LA_frappe_10_ddl.bioMod",
    ...
    objective_functions.add(custom_func_track_principal_finger_pi_in_two_global_axis, custom_type=ObjectiveFcn.Lagrange,
                            node=Node.ALL, phase=0, weight=100000*50, quadratic=True, target=pi_sur_2_phase_0,
    ...
    objective_functions.add(custom_func_track_principal_finger_pi_in_two_global_axis, custom_type=ObjectiveFcn.Lagrange,
                            ...
                            segment="2proxph_2mcp_flexion")
    objective_functions.add(custom_func_track_principal_finger_pi_in_two_global_axis, custom_type=ObjectiveFcn.Lagrange,
                            node=Node.ALL, phase=3, weight=100000*50, quadratic=True, target=pi_sur_2_phase_3,
                            segment="2proxph_2mcp_flexion")
