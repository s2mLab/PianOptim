...
def main():
    ...
    with open(
            "/0:On_going/5:FINAL_Squeletum_hand_finger_2_keys/frappe_&_pressed/4_phases/0_pressed/results/8_9_with_thorax_blocked_started_ended_nodes/8.pckl", "wb") as file:
