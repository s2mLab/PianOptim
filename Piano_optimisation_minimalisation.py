...
def prepare_ocp(
    ...
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1000, phase=3, index=[0, 1, 2, 3, 7, 8, 9, 10])
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1, phase=3, index=[4, 5, 6])
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1000, phase=4, index=[0, 1, 2, 3, 7, 8, 9, 10])
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1, phase=4, index=[4, 5, 6])
...
def main():
    ...
    with open("Piano_minimisation_1_humerus.pckl", "wb") as file:
