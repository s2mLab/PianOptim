...
def main():
    ...
    with open(
            "/2__FINAL_MODELES_OSCAR/5___FINAL_Squeletum_hand_finger_1_key_4_phases/pressed/1_every_dof_minimized_at_100/test_egality/1_every_dof_minimized_at_100.pckl", "wb") as file:
