...
def main():
    ...
    with open(
            "/0__On_going/Resultats_FINAL/pressed/3_FINAL_with_thorax_blocked_in_x_&_-1_in_z_&_thorax_pelvis_init_0/2_1000_100/2_a_finger_hand_radius_ulna_1000_others_100/test/1000_*10.pckl", "wb") as file:
