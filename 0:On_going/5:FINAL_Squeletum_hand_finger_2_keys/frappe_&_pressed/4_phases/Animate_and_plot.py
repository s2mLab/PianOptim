...
# w hand 10
# with open(
#         "/0:On_going/5:FINAL_Squeletum_hand_finger_2_keys/frappe_&_pressé/4_phases/results_download/4_pi_on_two_finger_ph0&3_10_ph1&2_100000_hand_10_100000_with_5_cm/4_pi_on_two_finger_ph0&3_10_ph1&2_100000_hand_10_100000_with_5_cm.pckl",
#           'rb') as file:new_dict = pickle.load(file)

# w hand 100
with open(
        "/0:On_going/5:FINAL_Squeletum_hand_finger_2_keys/frappe_&_pressé/4_phases/results_download/5_pi_on_two_finger_0&3_100_1&2_100000_hand_100_100000_with_5_cm/5_pi_on_two_finger_0&3_100_1&2_100000_hand_100_100000_with_5_cm.pckl",
          'rb') as file:new_dict = pickle.load(file)

biorbd_model_path: str = "/0:On_going/5:FINAL_Squeletum_hand_finger_2_keys/frappe_&_pressé/4_phases/Squeletum_hand_finger_3D_2_keys_octave_LA_frappe.bioMod"
