...
def main():
    ...
    with open(
            "/0:On_going/5:FINAL_Squeletum_hand_finger_2_keys/frappe_&_pressed/4_phases/0_frappe/results/3_zpiano_minus1cm_&_thorax_pelvis_init_0/1_zpiano_minus1cm_&_thorax_pelvis_init_0/1.pckl", "wb") as file:
