...
def prepare_ocp(
    ...
    objective_functions.add(custom_func_track_principal_finger_pi_in_two_global_axis, custom_type=ObjectiveFcn.Lagrange,
                            node=Node.ALL, phase=0, weight=1000000, quadratic=True, target=pi_sur_2_phase_0,
    ...
    objective_functions.add(custom_func_track_principal_finger_pi_in_two_global_axis, custom_type=ObjectiveFcn.Lagrange,
                            ...
                            segment="2proxph_2mcp_flexion")
    objective_functions.add(custom_func_track_principal_finger_pi_in_two_global_axis, custom_type=ObjectiveFcn.Lagrange,
                            node=Node.ALL, phase=3, weight=1000000, quadratic=True, target=pi_sur_2_phase_3,
                            segment="2proxph_2mcp_flexion")
    ...
    # [ phase 0 ]
    # [indice du ddl (0 et 1 position y z, 2 position y, 3 4 5 speed y z y),
...
def main():
    ...
    with open(
            "/0:On_going/5:FINAL_Squeletum_hand_finger_2_keys/frappe_&_pressed/4_phases/0_pressed/results/archive_bc_piano_badly_positionate/8_9_with_thorax_blocked_started_ended_nodes/9_and_pelvis.pckl", "wb") as file:
