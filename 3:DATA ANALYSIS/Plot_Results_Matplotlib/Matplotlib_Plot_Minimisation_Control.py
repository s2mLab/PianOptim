...
with open("../../1:DATA FILES - CALCULATIONS/Results_DoF_with_keys/Piano_results.pckl", 'rb') as file:new_dict = pickle.load(file)
...
axs[1, 0].plot(T, q[4, :], 'tab:red', label="Every limbs at 1000")
axs[1, 0].set_title("humerus_rotX_abduction(-)/adduction(+) \n")
axs[1, 0].plot(T, q2[3, :], 'tab:blue', label="Humerus at 1. Others at 1000.")
...
axs[1, 0].plot(T, qdot[4, :], 'tab:red', label="Every limbs at 1000.")
axs[1, 0].set_title("humerus_rotX_abduction(-)/adduction(+) \n")
axs[1, 0].plot(T, qdot2[3, :], 'tab:blue', label="Humerus at 1. Others at 1000.")
...
axs[1, 0].plot(T, U[4, :], 'tab:red', label="Every limbs at 1000.")
axs[1, 0].set_title("Tau_humerus_rotX_abduction(-)/adduction(+) \n")
axs[1, 0].plot(T, U2[3, :], 'tab:blue', label="Humerus at 1. Others at 1000.")
