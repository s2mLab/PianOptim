...
def prepare_ocp(
        biorbd_model_path: str = "/home/lim/Documents/Stage Mathilde/PianOptim/0:On going/4:FINAL_Finger_hand_2_keys/Frappé/FINAL_Frappé_Finger_hand_2_keys/7_Phases/7_FINAL_Pressed_Finger_hand_2_keys.bioMod",
    ...
    three_quarter_node_phase_1 = ceil(0.75 * n_shooting[0])
    three_quarter_node_phase_5 = ceil(0.75 * n_shooting[3])
    ...
    objective_functions.add(ObjectiveFcn.Mayer.TRACK_MARKERS_VELOCITY,
                            target=vel_pushing, node=three_quarter_node_phase_1, phase=0, marker_index=4,
                            weight=1000)
    objective_functions.add(ObjectiveFcn.Mayer.TRACK_MARKERS_VELOCITY,
                            target=vel_pushing, node=three_quarter_node_phase_5, phase=3, marker_index=4,
                            weight=1000)
    # Dynamics
