...
def prepare_ocp(
        biorbd_model_path: str = "/home/lim/Documents/Stage Mathilde/PianOptim/0:On going/Pressed/5:FINAL_Pressed_Finger_hand_2_keys_simulation_VELOCITY_PROFIL/7_FINAL_Pressed_Finger_hand_2_keys_simulation_VELOCITY_PROFIL.bioMod",
    ...
    objective_functions.add(ObjectiveFcn.Mayer.TRACK_MARKERS_VELOCITY,
                            target=vel_push_array, node=Node.INTERMEDIATES, axes=Axis.Z, phase=1, marker_index=4,
                            weight=1000)
    objective_functions.add(ObjectiveFcn.Mayer.TRACK_MARKERS_VELOCITY,
                            target=vel_push_array, node=Node.INTERMEDIATES, axes=Axis.Z, phase=5, marker_index=4,
                            weight=1000)
    # Dynamics
